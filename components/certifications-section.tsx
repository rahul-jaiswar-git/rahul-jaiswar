...
export default function CertificationsSection() {
  ...
  return (
    <section id="certifications" className="relative py-24 px-8 md:px-16 lg:px-24 bg-black/30">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          <Link
            href="/certifications"
            className="inline-block bg-teal-500/10 text-teal-300 font-medium px-6 py-3 rounded-full hover:bg-teal-500/20 transition-colors"
          >
